        ...
        <div class="container-fluid">
            ...
            <div class="m24_navigation_wrapper">
                ...
                <div class="navi_searchbar_wrapper">
                    ...
                    <input type="text" id="justAnotherInputBox" placeholder="查看歌手、专辑、歌单等" />
                </div>
...
<%--                            <img src="images/artist1.jpg" class="img-responsive" alt="img">--%>
<%--                            <div class="artist_wrapper_text">--%>
<%--                                <div class="artist_wrapper_left">--%>
<%--                                    <h1>Shack your butty</h1>--%>
<%--                                    <p>Arebica Luna</p>--%>
<%--                                    <p></p>--%>
<%--                                    <div class="artist_btn ms_cover">--%>
<%--                                        <div class="lang_apply_btn">--%>

<%--                                            <a href="#"><i class="flaticon-play-button"></i> 播放全部 </a>--%>

<%--                                        </div>--%>
<%--                                        <div class="cancel_wrapper">--%>
<%--                                            <a href="#"><i class="flaticon-radio"></i>  下载</a>--%>
<%--                                        </div>--%>
<%--                                    </div>--%>
<%--                                </div>--%>
...
<%--        </div>--%>
        ...
        <div class="album_inner_list auti ms_cover">
            <div class="container">
                <div class="row">
                        ...
                        <div class="album_list_wrapper2">
                            <div class="album_list_wrapper album_list_wrapper_shop">
                                <ul class="album_list_name ms_cover">
                                    <li>#</li>
                                    <li class="song_title_width">歌曲名</li>
                                    <li class="song_title_width">专辑</li>
                                    <li class="text-center">大小</li>
                                    <li class="text-center">更多</li>
                                </ul>
                                <%
                                    List<Song> result= (List<Song>) session.getAttribute("searchresult");
                                    int i=0;
                                    if(result!=null){
                                ...
                                <ul class="album_inner_list_padding">
                                    ...
                                    <li class="song_title_width">
                                        <div class="top_song_artist_wrapper">
                                            ...
                                            <img src=<%=song.getSongIcon()%> alt="img">

                                            <div class="top_song_artist_contnt">
                                                <h1><a href="#"><%=song.getSongName()%></a></h1>
                                                <p class="various_artist_text"><a href="#"><%=song.getSongSinger()%></a></p>
                                            </div>

                                        </div>
                                    </li>
                                    <li class="song_title_width"><a href="#"><%=song.getSongAlbum()%></a></li>
                                    <li class="text-center"><a href="#"><%=song.getSongSize()%></a></li>
...
<%--                                    <li class="text-center cancel_times"><a href="#"><i class="fas fa-times-circle"></i></a></li>--%>
                                </ul>
                                <%
                                        }
                                    }
                                %>
<%--                                <ul class="album_inner_list_padding">--%>
<%--                                    <li><a href="#"><span class="play_no">02</span><span class="play_hover"><i class="flaticon-play-button"></i></span></a></li>--%>
<%--                                    <li class="song_title_width">--%>
<%--                                        <div class="top_song_artist_wrapper">--%>
...
<%--                                        </div>--%>
<%--                                    </li>--%>
<%--                                    <li class="song_title_width"><a href="#">Kabir Singh — Arijit Singh 2019</a></li>--%>
...
<%--                                </ul>--%>
<%--                                <ul class="album_inner_list_padding">--%>
<%--                                    <li><a href="#"><span class="play_no">03</span><span class="play_hover"><i class="flaticon-play-button"></i></span></a></li>--%>
<%--                                    <li class="song_title_width">--%>
<%--                                        <div class="top_song_artist_wrapper">--%>
...
<%--                                </ul>--%>
<%--                                <ul class="album_inner_list_padding">--%>
<%--                                    <li><a href="#"><span class="play_no">04</span><span class="play_hover"><i class="flaticon-play-button"></i></span></a></li>--%>
<%--                                    <li class="song_title_width">--%>
<%--                                        <div class="top_song_artist_wrapper">--%>
...
<%--                                </ul>--%>
<%--                                <ul class="album_inner_list_padding">--%>
<%--                                    <li><a href="#"><span class="play_no">05</span><span class="play_hover"><i class="flaticon-play-button"></i></span></a></li>--%>
<%--                                    <li class="song_title_width">--%>
<%--                                        <div class="top_song_artist_wrapper">--%>
...
<%--                            </div>--%>
        ...
        <!-- new release wrapper start -->
<%--        <div class="treanding_songs_wrapper release_wrapper artist_release_wraper ms_cover">--%>
<%--            <div class="container">--%>
<%--                <div class="row">--%>
...
<%--                               <!-- <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home"> </a>--%>
<%--                                </li>--%>
<%--                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#menu1"></a>--%>
<%--                                </li>--%>
<%--                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#menu2"> </a>--%>
<%--                                </li>--%>
<%--                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#menu3"> </a>--%>
<%--                                </li>--%>
<%--                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#menu4">  </a>--%>
<%--                                </li>--%>
<%--                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#menu5"> </a>--%>
<%--                                </li>-->--%>
