            ...
            <div class="m24_navigation_wrapper">
                <div class="mainmenu d-xl-block d-lg-block d-md-none d-sm-none d-none">
                    <ul class="main_nav_ul">
                        ...
                        <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">浏览 <i
                        ...
                        <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">更多 <i
                                class="flaticon-down-arrow"></i></a>
                            <ul class="navi_2_dropdown">
                                <li class="parent">
                    ...
                    <div class="search_bar">
                        ...
                        <div id="search_open" class="res_search_box">
                            ...
                            <div class="lang_list_wrapper responsive_search_toggle">
                                <a href="#" data-toggle="modal" data-target="#myModal">语言 <i
                                        class="fas fa-language"></i></a>
                            </div>
                            <div class="m24_signin_wrapper responsive_search_toggle">

                                <a href="#" data-toggle="modal" data-target="#login_modal"><img src="images/pf.png"
                                                                                                alt="img">
                                    <div class="login_top_wrapper">
                                        <p></p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            <div class="more_playlist_wrapper ms_cover">
                                                <h1>Do you have what it takes? Show us your skills at <a href="#">Tunein@example.com</a>
                                                </h1>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="btm_foter_box">
                        ...
                        <p>Copyright © 2019 <a href="index.jsp"> Tunein </a> Template designed by <a href="#">
                            Webstrot.</a></p>
                            ...
                            <div class="control-primary">
                                ...
                                <a class="jp-play" role="button" tabindex="0">
                                    ...
                                    <span class="adonis-icon icon-pause icon-3x"><svg version="1.1"
                                            ...
                                            d="M1.6 0h8c0.884 0 1.6 0.716 1.6 1.6v28.8c0 0.884-0.716 1.6-1.6 1.6h-8c-0.884 0-1.6-0.716-1.6-1.6v-28.8c0-0.884 0.716-1.6 1.6-1.6z"></path></svg></span></a>
                    ...
                    <div class="col-sm-4 col-lg-4 col-xl-3 col-4">
                        <div class="jp_controls_wrapper">
                            ...
                            <div class="jp_adoins_wrapper"><a class="toggle-off-canvas" data-target="#adonis-playlist"
                                    ...
                                    class="adonis-icon icon-4x"><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
